...
@JsonSerializable()
  ...
  Area(this.value,this.label,this.city,);
...
@JsonSerializable()
  ...
  City(this.value,this.label,this.county,);
...
@JsonSerializable()
  ...
  County(this.value,this.label,);

  factory County.fromJson(Map<String, dynamic> srcJson) => _$CountyFromJson(srcJson);
