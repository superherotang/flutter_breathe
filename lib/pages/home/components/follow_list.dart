...
class FollowList extends GetView {
  const FollowList({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    var controller = Get.put(FollowListContoller());
...
class FollowListContoller extends GetxController {
  ...
  getPosts(int current) async {
    ...
    dynamic myResponse;
    try {
      myResponse = await PostsApi.getPostsInfoByUid(list, current);
